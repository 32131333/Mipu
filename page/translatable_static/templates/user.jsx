...
export default function UserPage() {
	...
	function LinkFromProfile(val) {
		...
		return <a className="app-st-userLinkBtn" href={st.link} onClick={e=>{e.preventDefault(); app.functions.youReallyWantToOpenLink(st.link)}}><FixedSVG>{app.___svgs.x_1}</FixedSVG> <div id="showtext">{st.text ?? st.link}</div></a>
	};

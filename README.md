...
| Комментарии | ✅(можно прикреплять картинки, как в постах, где-то возможность еще с 2024 года) | ✅ | ✅(Хотя и уж столь отличается) | Я незн |
| Удобство | ❌(сырое, не нативное приложение) | ✅ | ✅(почти) | Я незн, я ваще не имею доступа |
| Простота | ❌(хотя и чтобы зайти в него, достаточно одной ссылки) | ✅, но почти(есть ограничения, без мода никак) | ✅ | ❌(нужно логиниться для доступа |
